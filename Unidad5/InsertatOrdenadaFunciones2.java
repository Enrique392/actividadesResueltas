     ...
     */
        ...
        public static String[] insertar(String cesta[]){
            ...
            if (existe){
                ...
                cesta[cesta.length-1]=produtoNuevo; // en el ultimo indice pone el nuevo valor
        ...
        public static String[] eliminar(String cesta[]){
            mostrar("Indica el nombre del producto que quieras eliminar");
            String productoEliminar= sn.next();sn.nextLine();
            int indice= cesta.length+1;
            ...
            if (indice>cesta.length){
                mostrar("El producto indicado no esta en la cesta");
            }else{
        ...
        public static void salir(String [] cesta){
            System.out.println("\n-------------------------------");
            for (int i = 0; i < cesta.length; i++) {
